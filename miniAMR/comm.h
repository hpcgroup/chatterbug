...
EXT_VAR THREAD_VAR double *send_buff, *recv_buff;    /* use in comm and for balancing blocks */

EXT_VAR THREAD_VAR int s_buf_size, r_buf_size;

EXT_VAR THREAD_VAR int num_comm_partners[3],  // number of comm partners in each direction
...
EXT_VAR THREAD_VAR MPI_Request *request, *s_req;

EXT_VAR THREAD_VAR int max_num_req;
...
EXT_VAR THREAD_VAR par_comm par_b, par_p, par_p1;

EXT_VAR THREAD_VAR int *bin,
    *gbin;

EXT_VAR THREAD_VAR MPI_Comm *comms;
EXT_VAR THREAD_VAR int *me;
EXT_VAR THREAD_VAR int *np;
